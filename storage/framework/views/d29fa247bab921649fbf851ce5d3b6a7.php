    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="p-6 border-b border-gray-200">
            <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                ...
                <form method="GET" action="<?php echo e(route('admin.orders')); ?>" class="flex flex-col sm:flex-row gap-2">
                    <input type="text" 
                           name="search" 
                    ...
                    <?php if(request('search') || request('status')): ?>
                        <a href="<?php echo e(route('admin.orders')); ?>" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 text-sm font-medium">
                            Reset
                        </a>
                    <?php endif; ?>
                </form>
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-bold text-blue-600"><?php echo e($order->order_number); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($order->items->count()); ?> item(s)</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($order->user->name ?? 'N/A'); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($order->user->email ?? 'N/A'); ?></div>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-gray-900"><?php echo e($order->shipping_method_name); ?></div>
                                <div class="text-xs text-gray-500"><?php echo e($order->shipping_city); ?></div>
                            </td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Aplikasi Kasir v2\resources\views/admin/orders/index.blade.php ENDPATH**/ ?>