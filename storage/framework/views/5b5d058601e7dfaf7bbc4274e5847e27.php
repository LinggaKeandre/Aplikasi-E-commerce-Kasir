...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        ...
        <form action="<?php echo e(route('admin.products.store')); ?>" method="POST" enctype="multipart/form-data" novalidate 
              x-data="{ 
                  preview: null,
                  uploadMethod: 'file',
                  imageUrl: '',
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="meta" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Deskripsi singkat untuk preview..."><?php echo e(old('meta')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="6"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Deskripsi detail produk, spesifikasi, dll..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Aplikasi Kasir v2\resources\views/admin/products/create.blade.php ENDPATH**/ ?>