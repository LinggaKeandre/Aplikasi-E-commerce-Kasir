...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="<?php echo e(route('admin.banners.update', $banner)); ?>" 
              method="POST" 
              enctype="multipart/form-data"
              x-data="{ preview: '<?php echo e(asset('storage/' . $banner->image_path)); ?>' }">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition"
                        ...
                        <!-- New Preview -->
                        <div x-show="preview && preview !== '<?php echo e(asset('storage/' . $banner->image_path)); ?>'" 
                             class="mt-4">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <select name="position" 
                            ...
                            required>
                        <option value="home" <?php echo e(old('position', $banner->position) == 'home' ? 'selected' : ''); ?>>
                            Home / Katalog Member
                        </option>
                        <option value="customer_display" <?php echo e(old('position', $banner->position) == 'customer_display' ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Aplikasi Kasir v2\resources\views/admin/banners/edit.blade.php ENDPATH**/ ?>