...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600">Upload banner promosi untuk katalog member</p>
    </div>
        ...
        <div class="flex items-start">
            ...
            <div>
                ...
                <ul class="text-blue-700 text-sm space-y-1 mt-2">
                    ...
                    <li>• Banner akan tersimpan di folder <code class="bg-blue-100 px-1 rounded">storage/app/public/banners</code></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-lg p-8">
        <form action="<?php echo e(route('admin.banners.store')); ?>" 
              method="POST" 
                    ...
                    <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition"
                        ...
                        <div x-show="preview" class="relative">
                            ...
                            <button type="button"
                                    ...
                                    class="absolute top-2 right-2 bg-red-500 hover:bg-red-600 text-white p-2 rounded-full shadow-lg transition">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center">
                    ...
                    <label for="is_active" class="ml-3 text-sm font-medium text-gray-700">
                        Aktifkan banner setelah upload
                    </label>
                </div>
                ...
                <div>
                    ...
                    <select name="position" 
                            ...
                            required>
                        <option value="home" <?php echo e(old('position') == 'home' ? 'selected' : ''); ?>>
                            Home / Katalog Member
                        </option>
                        <option value="customer_display" <?php echo e(old('position') == 'customer_display' ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Aplikasi Kasir v2\resources\views/admin/banners/create.blade.php ENDPATH**/ ?>