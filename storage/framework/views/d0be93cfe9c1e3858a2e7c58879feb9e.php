    ...
    <div x-data="customerDisplay()" x-init="init()" class="h-screen flex">
        ...
        <div class="w-3/5 bg-gray-100 relative overflow-hidden">
            ...
            <?php if($banners->count() > 0): ?>
                <div x-data="{ currentSlide: 0, banners: <?php echo e($banners->toJson()); ?> }" 
            ...
            <div class="absolute bottom-6 right-6 bg-white/90 backdrop-blur px-4 py-2 rounded-lg shadow-lg z-20">
                <p class="text-sm font-semibold text-gray-700"><?php echo e(config('app.name')); ?></p>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\Aplikasi Kasir v2\resources\views/kasir/customer-display.blade.php ENDPATH**/ ?>