...
<div class="max-w-4xl mx-auto">
                    ...
                    <div class="bg-gradient-to-r from-blue-50 to-blue-100 px-6 py-4 border-b border-blue-200">
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <div class="font-bold text-gray-800 text-lg"><?php echo e($order->order_number); ?></div>
                            ...
                            <div class="flex items-center gap-2 px-3 py-1.5 rounded-lg border-2 <?php echo e($status['color']); ?> font-semibold text-sm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="font-bold text-gray-800"><?php echo e($order->items->count()); ?> Produk</div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center gap-2">
                                        <div class="font-bold text-gray-800"><?php echo e($order->shipping_method_name); ?></div>
                                    ...
                                    <div class="text-xs text-gray-600 mt-0.5"><?php echo e($order->shipping_city); ?></div>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <div class="font-bold text-blue-600 text-xl">Rp<?php echo e(number_format($order->total, 0, ',', '.')); ?></div>
                                    <div class="text-xs text-gray-600 mt-0.5 uppercase"><?php echo e($order->payment_method); ?></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <?php if($order->status !== 'delivered' && $order->status !== 'cancelled'): ?>
                            <div class="mt-4 pt-4 border-t border-gray-200">
                                <div class="flex items-center justify-between text-sm">
                                    ...
                                    <div class="font-semibold text-gray-800"><?php echo e($order->estimated_delivery->format('d M Y, H:i')); ?></div>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
    ...
    <?php else: ?>
        ...
        <div class="bg-white rounded-xl shadow-md p-12 text-center">
            ...
            <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 font-semibold">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\Aplikasi Kasir v2\resources\views/orders/index.blade.php ENDPATH**/ ?>