...
<head>
    ...
    <title><?php echo e(config('app.name','Kasir')); ?></title>
...
<body x-data="{sidebar:false, photoModal: false, photoUrl: ''}" class="antialiased bg-gray-50">
    ...
    <!-- Modal Login -->
    <div x-data="{open:<?php echo e($errors->has('email') ? 'true' : 'false'); ?>}" 
        ...
        <div @click.away="open=false" class="bg-white rounded-lg shadow-lg p-8 w-full max-w-md relative">
            ...
            <div class="mt-6 text-center text-sm">
                Belum punya akun? <a href="<?php echo e(route('register.form')); ?>" class="text-blue-600 hover:underline font-medium">Daftar di sini</a>
            </div>
        </div>
    </div>
    ...
    <div x-show="sidebar" class="fixed inset-0 z-50 flex" 
        ...
        <div @mouseenter="sidebar=true" @mouseleave="sidebar=false" class="w-64 bg-white h-full shadow-2xl flex flex-col transform transition-transform duration-200"
            ...
            <a href="<?php echo e(route('profile.show')); ?>" class="p-6 hover:bg-gray-50 transition border-b border-gray-200 block">
                <div class="flex items-center justify-between mb-2">
                    <div class="flex items-center gap-3">
                        ...
                        <?php endif; ?>
                        <div>
                            <div class="font-bold text-gray-800"><?php echo e(Auth::user()->name ?? 'Member'); ?></div>
            ...
            <nav class="flex-1 flex flex-col gap-2 p-4">
                <a href="<?php echo e(route('home')); ?>" class="py-2 px-3 rounded hover:bg-gray-100 flex items-center gap-2 <?php echo e(request()->routeIs('home') || request()->routeIs('product.show') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/>
                    </svg>
                    Katalog
                </a>
                <a href="<?php echo e(route('orders.index')); ?>" class="py-2 px-3 rounded hover:bg-gray-100 flex items-center gap-2 <?php echo e(request()->routeIs('orders.*') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/>
                    </svg>
                    Pesanan
                </a>
                <a href="<?php echo e(route('cart.index')); ?>" class="py-2 px-3 rounded hover:bg-gray-100 flex items-center gap-2 <?php echo e(request()->routeIs('cart.*') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"/>
                    </svg>
                    Keranjang
                </a>
                <a href="<?php echo e(route('rewards.index')); ?>" class="py-2 px-3 rounded hover:bg-gray-100 flex items-center gap-2 <?php echo e(request()->routeIs('rewards.*') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                    </svg>
                    Rewards
                </a>
                <a href="<?php echo e(route('member.vouchers')); ?>" class="py-2 px-3 rounded hover:bg-gray-100 flex items-center gap-2 <?php echo e(request()->routeIs('member.vouchers') ? 'bg-blue-100 text-blue-700 font-semibold' : 'text-gray-700'); ?>">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php /**PATH C:\xampp\htdocs\Aplikasi Kasir v2\resources\views/layouts/app.blade.php ENDPATH**/ ?>