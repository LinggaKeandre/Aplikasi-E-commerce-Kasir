    ...
    <div class="mb-6 border-b border-gray-200">
        <nav class="flex gap-4">
            ...
            <button @click="activeTab = 'alerts'" 
                ...
                @endphp
                @if($totalAlerts > 0)
                <span class="ml-1 bg-red-500 text-white text-xs font-bold px-2 py-0.5 rounded-full">{{ $totalAlerts }}</span>
                @endif
            </button>
        </nav>
    </div>
    ...
    <div x-show="activeTab === 'stats'" x-cloak>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-blue-500">
                ...
                <div class="text-3xl font-bold text-gray-800">{{ $stats['sales_today'] }}</div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-green-500">
                ...
                <div class="text-3xl font-bold text-gray-800">{{ $stats['sales_month'] }}</div>
                <div class="text-xs text-gray-500 mt-1">pesanan</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-yellow-500">
                ...
                <div class="text-2xl font-bold text-gray-800">Rp{{ number_format($stats['revenue_today'], 0, ',', '.') }}</div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6 border-l-4 border-purple-500">
                ...
                <div class="text-2xl font-bold text-gray-800">Rp{{ number_format($stats['revenue_month'], 0, ',', '.') }}</div>
                <div class="text-xs text-gray-500 mt-1">rupiah</div>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="text-2xl font-bold text-gray-800">{{ $stats['total_orders'] }}</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-4">
                ...
                <div class="text-2xl font-bold text-blue-600">{{ $stats['total_customers'] }}</div>
            </div>

            <!-- Stok Menipis -->
            <div class="bg-white rounded-lg shadow p-4">
                <div class="text-gray-600 text-sm mb-1">Stok Menipis</div>
                <div class="text-2xl font-bold text-orange-600">{{ $stats['low_stock'] }}</div>
            </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div class="bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg shadow p-5 border border-purple-200">
                ...
                <div class="text-2xl font-bold text-purple-900">{{ $stats['kasir_today'] }} <span class="text-sm font-normal">hari ini</span></div>
                <div class="text-xs text-purple-700 mt-1">Rp {{ number_format($stats['kasir_revenue_today'], 0, ',', '.') }}</div>
            </div>
            ...
            <div class="bg-gradient-to-br from-cyan-50 to-cyan-100 rounded-lg shadow p-5 border border-cyan-200">
                ...
                <div class="text-2xl font-bold text-cyan-900">{{ $stats['online_today'] }} <span class="text-sm font-normal">hari ini</span></div>
                <div class="text-xs text-cyan-700 mt-1">Rp {{ number_format($stats['online_revenue_today'], 0, ',', '.') }}</div>
            </div>
            ...
            <div class="bg-gradient-to-br from-amber-50 to-amber-100 rounded-lg shadow p-5 border border-amber-200">
                ...
                <div class="text-2xl font-bold text-amber-900">{{ $stats['pending_orders'] }}</div>
            ...
            <div class="bg-gradient-to-br from-teal-50 to-teal-100 rounded-lg shadow p-5 border border-teal-200">
                ...
                <div class="text-lg font-bold text-teal-900">Rp {{ number_format($stats['avg_order_value'], 0, ',', '.') }}</div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-indigo-500">
                ...
                <div class="text-2xl font-bold text-indigo-600">{{ $stats['new_customers_week'] }}</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-pink-500">
                ...
                <div class="text-2xl font-bold text-pink-600">{{ number_format($stats['points_given_month']) }}</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-emerald-500">
                ...
                <div class="text-xl font-bold text-emerald-600">Rp {{ number_format($stats['inventory_value'], 0, ',', '.') }}</div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-5 border-l-4 border-rose-500">
                ...
                <div class="text-2xl font-bold text-rose-600">{{ $stats['cancelled_month'] }}</div>
            </div>
        </div>
    </div>
                        ...
                        <div>
                            <div class="flex items-center justify-between mb-1">
                                ...
                                <div class="flex items-center gap-3">
                                    <span class="text-xs text-gray-600">{{ $day['count'] }} order</span>
                                    <span class="text-sm font-semibold text-blue-600">Rp {{ number_format($day['revenue'], 0, ',', '.') }}</span>
                                </div>
                            </div>
                ...
                <div class="space-y-4">
                    @foreach($topProducts as $index => $item)
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <img src="{{ $item->product->image_url }}" alt="{{ $item->product->title }}" class="w-12 h-12 object-cover rounded">
                            ...
                            <div class="text-right">
                                <div class="text-lg font-bold text-blue-600">{{ $item->total_sold }}</div>
            ...
            <div class="bg-gradient-to-br from-violet-50 to-violet-100 rounded-lg shadow p-6 border border-violet-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-bold text-violet-900">{{ $stats['active_vouchers'] }}</div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-sky-50 to-sky-100 rounded-lg shadow p-6 border border-sky-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-bold text-sky-900">{{ $stats['pending_reviews'] }}</div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-red-50 to-red-100 rounded-lg shadow p-6 border border-red-200">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-3xl font-bold text-red-900">{{ $stats['pending_cancellations'] }}</div>
                    </div>
            ...
            <div class="bg-gradient-to-br from-red-50 to-orange-50 rounded-lg shadow-md overflow-hidden border-2 border-red-200">
                <div class="p-6 border-b border-red-200 bg-red-50/50">
                    <div class="flex items-center gap-3">
                        ...
                        <div class="ml-auto">
                            <span class="bg-red-500 text-white text-sm font-bold px-3 py-1 rounded-full">{{ $alertProducts->count() }}</span>
                        </div>
                    </div>
                </div>
