...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="mb-6">
        ...
        <p class="text-gray-600">Update informasi produk: <span class="font-semibold">{{ $product->title }}</span></p>
    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div x-show="hasVariantWithPrice()" x-transition class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        ...
                        <input type="hidden" name="price" :value="{{ $product->price }}" :disabled="!hasVariantWithPrice()">
                    </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="meta" 
                                  ...
                                  rows="3"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Deskripsi singkat untuk preview...">{{ old('meta', $product->meta) }}</textarea>
                        @error('meta')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" 
                                  ...
                                  rows="6"
                                  class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                  placeholder="Deskripsi detail produk, spesifikasi, dll...">{{ old('description', $product->description) }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
