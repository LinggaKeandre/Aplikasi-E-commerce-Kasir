    ...
    <div class="mb-6">
        ...
        @if($search)
            <p class="mt-3 text-sm text-gray-600">
                Hasil pencarian untuk: <span class="font-semibold text-gray-800">"{{ $search }}"</span>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($products as $product)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                @if($product->hasVariantPrices())
                                    <div class="text-sm font-bold text-gray-900">{{ $product->formatted_price_range }}</div>
                                ...
                                @else
                                    ...
                                    @if($product->discount)
                                        <div class="text-xs text-green-600 font-semibold">{{ $product->formatted_final_price }}</div>
                                    @endif
                                @endif
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                @if($product->discount)
                                    <span class="text-red-600 font-bold">{{ $product->discount }}%</span>
                                @else
