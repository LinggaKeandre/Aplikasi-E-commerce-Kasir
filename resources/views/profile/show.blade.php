@extends(Auth::user()->role === 'admin' ? 'layouts.admin' : (Auth::user()->role === 'kasir' ? 'layouts.kasir' : 'layouts.app'))
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-lg shadow p-6 mt-6">
                ...
                <form method="POST" action="{{ route('profile.password') }}" x-data="{open: false}">
                    @csrf
                    @method('PUT')
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow p-6 sticky top-20">
                ...
                <div class="flex flex-col items-center" x-data="{
                    ...
                    <form method="POST" action="{{ route('profile.photo.upload') }}" enctype="multipart/form-data" class="w-full" 
                    ...
                    @if($user->photo)
                        <form method="POST" action="{{ route('profile.photo.delete') }}" class="w-full mt-2">
                            @csrf
                            @method('DELETE')
